...
a wind-up situation.</p>
      ...
      IO.TemperatureInput T_min annotation (extent=[-44,-2; -36,6]);
    equation 
      T_min = T_env;
    ...
    equation 
      connect(limiter.limit2, T_min) annotation (points=[-22,2; -31,2; -31,2; 
              -40,2], style(color=74, rgbcolor={0,0,127}));
    end Simple;
